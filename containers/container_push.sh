...
docker tag sneaky-snake-arbiter-api:latest 277790246569.dkr.ecr.us-east-1.amazonaws.com/sneaky-snake-arbiter-api:latest
docker push 277790246569.dkr.ecr.us-east-1.amazonaws.com/sneaky-snake-arbiter-api:latest
